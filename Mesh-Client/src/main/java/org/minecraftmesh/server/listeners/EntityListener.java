...
public abstract class EntityListener implements IListenerBase
{
	...
	public abstract void onSetSize(Entity entity, float width, float height);

	public abstract void onSetRotation(Entity entity, float yaw, float pitch);

	public abstract void onSetPosition(Entity entity, double x, double y, double z);
	...
	public abstract void onExplode(Entity bomb, float ExplosionSize);
