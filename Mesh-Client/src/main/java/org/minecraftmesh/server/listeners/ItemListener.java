...
public abstract class ItemListener implements IListenerBase
{
	...
	public abstract void onPlayerStoppedUsing(ItemStack itemstack, World world, EntityPlayer entityplayer, int amtOfItem);
